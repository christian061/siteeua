    ...
    function setupCertificateModal() {
        ...
        function applyZoom(img) {
            ...
            if (state.zoomLevel > 1) {
                ...
                img.style.webkitTransform = transform; // Para compatibilidade com iOS
        ...
        function setupMobileZoom() {
            ...
            style.textContent = `
                ...
                #certificateModal img {
                    ...
                    -webkit-transform: translateZ(0); /* Melhora performance no iOS */
            ...
            container.addEventListener('touchmove', function(e) {
                ...
                if (e.touches.length === 2) {
                    ...
                    const newZoomLevel = Math.max(1, Math.min(5, touchStartZoom * scale));
                    
                    // Atualiza o zoom
                    state.zoomLevel = newZoomLevel;
                    
                    // Aplica o zoom
                    activeImg.style.transform = `scale(${newZoomLevel})`;
                    
                    // Se o zoom for 1x, reseta a posição
                    if (newZoomLevel <= 1) {
